...
class NeuralCDE(torch.nn.Module):
    ...
    def forward(self, data):
        ...
        #z_hat1 = torchcde.cdeint(X=X, z0=z1, func=self.func, t=X.grid_points)
    ...
    def predict(self, data, z0): # never be called

        data = self.readin(data)
