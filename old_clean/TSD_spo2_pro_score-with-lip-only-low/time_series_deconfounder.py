...
from rmsn.script_rnn_fit import rnn_fit, sc_fit
...
def train_sc(dataset_map, model_name, b_use_predicted_confounders):
    model_name = model_name + 'sc__use_confounders_' + str(b_use_predicted_confounders)
    MODEL_ROOT = os.path.join('results', model_name)
    ...
    sc_fit(dataset_map=dataset_map, networks_to_train='propensity_networks', MODEL_ROOT=MODEL_ROOT,
            b_use_predicted_confounders=b_use_predicted_confounders) #.to(device)
    # print("generating propensity scores")
    # propensity_generation(dataset_map=dataset_map, MODEL_ROOT=MODEL_ROOT,
    #                       b_use_predicted_confounders=b_use_predicted_confounders)
    # print("training ")
